...
[`@aws-sdk/credential-providers`](https://www.npmjs.com/package/@aws-sdk/credential-providers/v/3.1044.0).
...
- @aws-sdk/credential-providers - [https://cloud-sdk-builds.github.io/?sdk=credential-providers](https://cloud-sdk-builds.github.io/?sdk=credential-providers)
- @aws-sdk/credential-providers v3.1044.0 - [https://cloud-sdk-builds.github.io/?sdk=credential-providers&version=3.1044.0](https://cloud-sdk-builds.github.io/?sdk=credential-providers&version=3.1044.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/credential-providers@3.1044.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jRXXTZ3uUUOKudj1a8yufZ7rY+nWzhtaCIQ161L8LUPuYRrh/oQWj0AzN7PKv3A5
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/credential-providers/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/credential-providers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/credential-providers@3.1044.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/credential-providers@3.1044.0/index.min.mjs": "sha384-jRXXTZ3uUUOKudj1a8yufZ7rY+nWzhtaCIQ161L8LUPuYRrh/oQWj0AzN7PKv3A5"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/credential-providers";
...
```
https://github.com/cloud-sdk-builds/credential-providers/blob/refs/tags/3.1044.0/LICENSE
```
